...
/***/ function(module, exports, __webpack_require__) {
	...
	var swiper1 = new Swiper('.swiper-container1', {
	    autoHeight: true, //不会留白，根据每个tab内长度
	...
	var myScroll = new IScroll('#scroll1', { mouseWheel: true });
	myScroll.refresh();
	document.addEventListener('touchmove', function(e) { e.preventDefault(); }, false);

	var myScroll1 = new IScroll('#scroll2', { mouseWheel: true });
	// document.addEventListener('touchmove', function(e) { e.preventDefault(); }, false);
	myScroll1.refresh();

	var myScroll2 = new IScroll('#scroll3', { mouseWheel: true, scrollbars: true });
	// myScroll2.refresh();
	setTimeout(function() {
	    myScroll2.refresh();
	}, 100);
	...
	// document.addEventListener('touchmove', function(e) { e.preventDefault(); }, false);
	var myScroll3 = new IScroll('#scroll4', { mouseWheel: true });
	myScroll3.refresh();

	// document.addEventListener('touchmove', function(e) { e.preventDefault(); }, false);
	var myScroll4 = new IScroll('#scroll5', { mouseWheel: true });
	myScroll4.refresh();
	$('.btn1').tap(function() {
	    $('#mainContent').show();
	    $('.swiper-container').hide();
	    ...
	    //         var html = response[i].name;
	    //         console.log(html);
	    //         $('.licon').eq(i).find('span').eq(1).html(html);
	    //     }
	...
	// $('#scroller ul').on('swipeLeft', function() {
	//     console.log(1);
	// })
