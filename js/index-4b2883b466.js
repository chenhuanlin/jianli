...
/***/ function(module, exports, __webpack_require__) {
	...
	$('.btn1').tap(function() {
	    ...
	    var myScroll1 = new IScroll('#iscrollerLi1', { mouseWheel: true });
	    var myScroll2 = new IScroll('#iscrollerLi2', { mouseWheel: true });
	    var myScroll3 = new IScroll('#iscrollerLi3', { mouseWheel: true });
	    var myScroll4 = new IScroll('#iscrollerLi4', { mouseWheel: true });
	    var myScroll5 = new IScroll('#iscrollerLi5', { mouseWheel: true });
